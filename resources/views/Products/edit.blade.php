    ...
    <div class="card-style-3 mb-30">
                ...
                <form action="{{route('Products.update',$product->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-12">
                        <div class="input-style-1">
                            ...
                            <input type="text" class="form-control" value="{{$product->title}}" name="title" id="name" oninput="countCharacters(this,1)">
        ...
        <div class="col-12">
            <div class="input-style-1">
                ...
                <textarea name="description" id="editor" class="full-editor">{!! $product->description !!}</textarea>
