    ...
    <div class="card-style-3 mb-30">
        ...
        <div class="col-12">
            <div class="input-style-1">
                ...
                <input type="text" class="form-control" name="social_title" oninput="countCharacters(this,5)" value="{{old('social_title')}}">
        ...
        <div class="col-12">
            <div class="input-style-1">
                ...
                <input type="text" class="form-control" name="social_alt_text" oninput="countCharacters(this,8)" value="{{old('social_alt_text')}}">
        ...
        <div class="col-12">
            <div class="input-style-1">
                ...
                <input type="text" class="form-control" name="meta_title" oninput="countCharacters(this,9)" value="{{old('title_tag')}}">
        ...
        <div class="col-12">
            <div class="input-style-1">
                ...
                <input type="text" class="form-control" name="meta_link" oninput="countCharacters(this,10)" value="{{old('meta_link')}}">
